      ...
      <div className="max-w-4xl mx-auto space-y-8 text-gray-700 leading-relaxed">
        ...
        <div>
          ...
          <p className="text-gray-700">
            ...
            <span className="font-semibold"> Fabrany (or Febrany) Kulinji</span>
            , who played a key role in the tribe’s early migration and
            settlement.
          </p>
          <p className="text-gray-700 mt-2">
            The tribe later migrated and eventually settled in{" "}
            <span className="italic">Chitidzi</span>. Several members of the
            clan moved with the founding family.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-700">
            ...
            <span className="font-semibold">Fabrany Kulinji</span> had three
            sons:
          </p>
          <ul className="list-disc list-inside text-gray-700 mt-2 space-y-1">
            <li>Fabrany Kulinji</li>
        ...
        <div>
          ...
          <p className="text-gray-700">
            <span className="font-semibold">Fabrany Kulinji:</span> Described as
            a <span className="italic">hunter</span>, responsible for providing
            food and resources.
          </p>
          <p className="text-gray-700 mt-1">
            <span className="font-semibold">Thomson Kulinji:</span> Described as
            a <span className="italic">fisherman</span>. He moved from Chitidzi
        ...
        <div>
          ...
          <p className="text-gray-700">
            ...
            <span className="italic">Miah</span>.
          </p>
          <p className="text-gray-700 mt-1">
            <span className="font-semibold">Andrea:</span> Had two sons:{" "}
            <span className="italic">Nolah</span> and{" "}
            <span className="italic">Piyson Chimwemwe</span>.
          </p>
          <p className="text-gray-700 mt-1">
